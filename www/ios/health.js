...
units['steps'] = 'count';
units['swimming.distance'] = 'meters';
...
//            Health.prototype.queryActivitySummary = function (opts, onSuccess, onError) {
//
//            };
...
//    Health.prototype.queryElectrocardiogramSamples = function (opts, onSuccess, onError) {
//        window.plugins.healthkit.queryElectrocardiogramSamples(opts, function (data) {
//            console.warn(data);
//        }, onError);
//    }
